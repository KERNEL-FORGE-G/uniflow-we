...
export default function GradesPage() {
  ...
  // Lecture mise en cache et persistée : le relevé reste consultable hors ligne.
  const { data, loading, error, refetch, refreshing } = useApi(() => gradesApi.mine(), [], { key: 'grades.mine' })
  const grades: Grade[] = data ?? []
