...
export default function IndependentWorkspacePage({ initialTab }: { initialTab?: Tab }) {
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-6 pb-12">
      ...
      <InlineAlert tone="success" icon={<CheckCircle2 className="h-5 w-5" />} message="Les données de cet espace sont lues et enregistrées directement dans Appwrite pour votre compte personnel." />
              ...
              return (
                <div key={day} className="relative border-r border-slate-200 last:border-r-0 dark:border-slate-800" style={{ height: gridHeight }}>
                  ...
                  {dayItems.map(item => {
                    ...
                    const color = course?.colorHex || '#0d9488'
                    return (
