...
Après publication de `a782d25`, Vercel est `READY` et l’accueil charge `https://uniflow.kernelforge.codes/logos/uniflow-landing-original.webp`. Le navigateur confirme un décodage effectif de 1 200 × 900 pixels et un rendu à 492 × 369 pixels dans le cadre héro. Le visuel visible est bien l’illustration UniFlow suivie dans le dépôt, sans recours à l’ancienne URL Imgur.
