...
if (!apiKey) throw new Error('APPWRITE_SELF_HOSTED_API_KEY est requise pour déployer la Function des réactions Forum.')
...
async function ensureFunction() {
  const definition = { functionId, name: 'UniFlow — Réactions Forum', runtime: 'node-16.0', execute: ['users'], events: [], schedule: '', timeout: 30, enabled: true, logging: true, entrypoint: 'src/main.js', commands: 'npm install' }
